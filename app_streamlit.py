...
if st.button("Predecir"):
    ...
    st.write(f"La categoría recomendada para invertir con {stars} estrellas en {state} es: {predicted_category[0]}")
...
if st.button("Predecir Categoría por Ciudad"):
    ...
    st.write(f"La categoría recomendada para invertir con {stars_city} estrellas en {city} es: {predicted_category_city[0]}")
